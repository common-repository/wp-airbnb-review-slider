	...
	if (isset($_POST['wpairbnb_submittemplatebtn'])){
		...
		if($t_id==""){
			...
			if($updatetempquery>0){
				$dbmsg = '<div id="setting-error-wpairbnb_message" class="updated settings-error notice is-dismissible">'.__('<p><strong>Template Updated!</strong></p><button type="button" class="notice-dismiss"><span class="screen-reader-text">Dismiss this notice.</span></button>', 'wp-fb-reviews').'</div>';
			}
		}
...
<div class="wpairbnb_margin10">
	...
	<a id="wpairbnb_addnewtemplate" class="button dashicons-before dashicons-plus-alt"><?php _e('Add New Reviews Template', 'wp-fb-reviews'); ?></a>
</div>
		...
		<tbody>
			...
			<tr class="wpairbnb_row">
				...
				<td><div id="divtemplatestyles">
					...
					<label for="wpairbnb_template_type1-radio"><?php _e('Post or Page', 'wp-fb-reviews'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<label for="wpairbnb_template_type2-radio"><?php _e('Widget Area', 'wp-fb-reviews'); ?></label>
					</div>
					<p class="description">
...
<tr class="wpairbnb_row">
				...
				?>
					...
					<p class="description">
					<?php _e('More styles available in <a href="?page=wp_airbnb-get_pro">Pro Version</a> of plugin!', 'wp-fb-reviews'); ?></p>
				</td>
			</tr>
			<tr class="wpairbnb_row">
				<th scope="row">
				...
				<td>
					<textarea name="wpairbnb_template_css" id="wpairbnb_template_css" cols="50" rows="4"><?php echo $currenttemplate->template_css; ?></textarea>
					<p class="description">
			...
			<tr class="wpairbnb_row">
				...
				<td><div class="divtemplatestyles">
					<label for="wpairbnb_t_display_num"><?php _e('How many per a row?', 'wp-fb-reviews'); ?></label>
					...
					<label for="wpairbnb_t_display_num_rows"><?php _e('How many total rows?', 'wp-fb-reviews'); ?></label>
			...
			<tr class="wpairbnb_row">
				...
				<td>
					<div class="divtemplatestyles">
						<label for="wpairbnb_t_createslider"><?php _e('Display reviews in slider?', 'wp-fb-reviews'); ?></label>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label for="wpairbnb_t_display_num_rows"><?php _e('How many total slides?', 'wp-fb-reviews'); ?></label>
			...
			<tr>
				<td class="notice updated " colspan="2" style="border-left: 4px solid #d6d6d6;">
					<p><strong><?php _e('Upgrade to the Pro Version of this plugin to access more super cool settings! <a href="#TB_inline?tempnum=1&inlineId=mythickboxid&height=650&width=1030" class="thickbox">(Screenshot)</a> Get the Pro Version <a href="?page=wp_airbnb-get_pro">here</a>!', 'wp-fb-reviews'); ?></strong></p>
				</td>
			</tr>
	...
	<input type="submit" name="wpairbnb_submittemplatebtn" id="wpairbnb_submittemplatebtn" class="button button-primary" value="<?php _e('Save Template', 'wp-fb-reviews'); ?>">
	<a id="wpairbnb_addnewtemplate_cancel" class="button button-secondary"><?php _e('Cancel', 'wp-fb-reviews'); ?></a>
	</form>
</div>
<div class=""><p>Do you like this plugin? If so please take a moment to leave us a review <a href="https://wordpress.org/plugins/wp-airbnb-review-slider/" target="blank">here!</a> If it's missing something then please contact us <a href="http://ljapps.com/contact/" target="blank">here</a>. Thanks!</p></div>

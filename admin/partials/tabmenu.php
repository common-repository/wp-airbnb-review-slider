...
?>	
	...
	<a href="<?php echo $urlreviewlist; ?>" class="nav-tab <?php if($_GET['page']=='wp_airbnb-reviews'){echo 'nav-tab-active';} ?>"><?php _e('Reviews List', 'wp-airbnb-review-slider'); ?></a>
	...
	<a href="<?php echo $urlforum; ?>" class="nav-tab <?php if($_GET['page']=='wp_airbnb-get_pro'){echo 'nav-tab-active';} ?>"><?php _e('Get Pro Version', 'wp_airbnb-get_pro'); ?></a>

	...
	$(function(){
		...
		$( ".wpairbnb_displayshortcode" ).click(function() {
		  ...
		  if(ttype=="widget"){
			...
			openpopup("How to Display", '<p>Enter this shortcode on a post or page: </br></br>[wpairbnb_usetemplate tid="'+tid+'"]</p><p>Or you can add the following php code to your template: </br></br><code> do_action( \'wprev_airbnb_plugin_action\', '+tid+' ); </code></p>', '');
		  }

(function( $ ) {
	...
	$(function(){
		...
		$( "#wpairbnb_removeallbtn" ).click(function() {
		  openpopup("Are you sure?", '<p>This will delete all reviews in your Wordpress database including the ones you manually entered. It Does NOT affect your reviews on Facebook.</p>', '<a class="button dashicons-before dashicons-no" href="?page=wp_airbnb-reviews&opt=delall">Remove</a>');
		});	

		//upgrade to pro
		$( ".wpairbnb_upgrade_needed" ).click(function() {
		  openpopup("Upgrade Needed", '<p>Please upgrade to the Pro Version of this Plugin to access this feature.</p>', '<a class="button dashicons-before  dashicons-cart" href="?page=wp_airbnb-get_pro">Upgrade Here</a>');
		});		
